...
assert.match(renderer, /@media \(max-width: 1654px\) \{[\s\S]*\.ordinary-floor \.zone-list-box \{ width: 854px; grid-template-columns: repeat\(5, minmax\(0, 162px\)\); \}[\s\S]*nth-child\(n \+ 11\)/);
